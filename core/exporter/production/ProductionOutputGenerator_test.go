...
func TestProcessFileDefaultConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{ // Without parsing error
			...
			expectedFilename: "01_TestProductionWithoutParsingError_DEFAULT_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},

		{ // With parsing error
			inputFilename:    "02_TestProductionParsingError.xlsx",
			expectedFilename: "02_TestProductionParsingError_DEFAULT_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},
		{ // Empty coded statement in 1 row having the same length as the header
			...
			expectedFilename: "03_TestProductionEmptyCodedStatementSameRowLength_DEFAULT_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},
		...
		{ // Empty coded statement in 1 row having a shorter length than the header
			...
			expectedFilename: "04_TestProductionEmptyCodedStatementLessRowLength_DEFAULT_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},

		{ // Empty coded statement in 1 row having a shorter length than the header
			inputFilename:    "05_TestProductionOneColumnOffset.xlsx",
			expectedFilename: "05_TestProductionOneColumnOffset_DEFAULT_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},
		{ // Empty rows, and parsing errors to test the dinamycally increment of stmtID
			...
			expectedFilename: "06_TestProductionErrorsAndEmptyRows_DEFAULT_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},
		{ // Empty rows, and parsing errors to test the dinamycally increment of stmtID
			inputFilename:    "07_TestProductionComplexStatementsWithAnnotations.xlsx",
...
func TestProcessFileExtendedOutput(t *testing.T) {

	// IG Extended output: false
	tabular.SetProduceIGExtendedOutput(true)
	// IG Logical output: false
	tabular.SetIncludeAnnotations(false)
	...
	tests := []struct {
		...
		{ // Empty rows, and parsing errors to test the dinamycally increment of stmtID
			inputFilename:    "07_TestProductionComplexStatementsWithAnnotations.xlsx",
			expectedFilename: "07_TestProductionComplexStatementsWithAnnotations_EXTENDED_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},
	}
...
func TestProcessFileExtendedOutputIncludeAnnotations(t *testing.T) {
	...
	tests := []struct {
		...
		{ // Empty rows, and parsing errors to test the dinamycally increment of stmtID
			inputFilename:    "07_TestProductionComplexStatementsWithAnnotations.xlsx",
			expectedFilename: "07_TestProductionComplexStatementsWithAnnotations_EXTENNDED_ANNOTATIONS_CODED.xlsx",
			expectedErr:      PRODUCTION_NO_ERROR,
		},
	}
